...
import LangButton from '~/routes/layouts/components/lang-button';
import NavButton from '~/routes/layouts/components/nav-button';
    ...
    <header className="fixed z-50 h-[60px] w-full bg-white">
      <div className="container flex h-full items-center justify-between">
        ...
        <div>
          ...
          <span className="text-[15px] font-[500] text-[#d1d6db]">|</span>
